 ...
 * EROS system. There are three: the main network on which people trade goods
...
public:
    ...
    int ErosBadBlockTime() const { return nErosBadBlockTime; }
    int ErosBadBlocknBits() const { return nErosBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nErosBadBlockTime;
    unsigned int nErosBadBlocknBits;
