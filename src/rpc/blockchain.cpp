...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zersObj.push_back(Pair(std::to_string(denom), ValueFromAmount(blockindex->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zersObj.push_back(Pair("total", ValueFromAmount(blockindex->GetZerocoinSupply())));
...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in eros\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw std::runtime_error(
            ...
            "  \"zERSsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zERS denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zERS denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zERS denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zERS denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zERS denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zERS denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zERS denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zERS denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zERS denominations\n"
            "  },\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw std::runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of eros addresses\n"
...
UniValue getblockindexstats(const UniValue& params, bool fHelp) {
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw std::runtime_error(
                ...
                "  }\n"
                "  \"txbytes\": xxxxx                (numeric) Sum of the size of all txes (zERS excluded) over block range\n"
                "  \"ttlfee\": xxxxx                 (numeric) Sum of the fee amount of all txes (zERS mints excluded) over block range\n"
                "  \"ttlfee_all\": xxxxx             (numeric) Sum of the fee amount of all txes (zERS mints included) over block range\n"
