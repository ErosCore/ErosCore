...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EROS features */
        {"eros", "listmasternodes", &listmasternodes, true },
        {"eros", "getmasternodecount", &getmasternodecount, true },
        {"eros", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"eros", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"eros", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"eros", "masternodecurrent", &masternodecurrent, true },
        {"eros", "startmasternode", &startmasternode, true },
        {"eros", "createmasternodekey", &createmasternodekey, true },
        {"eros", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"eros", "listmasternodeconf", &listmasternodeconf, true },
        {"eros", "getmasternodestatus", &getmasternodestatus, true },
        {"eros", "getmasternodewinners", &getmasternodewinners, true },
        {"eros", "getmasternodescores", &getmasternodescores, true },
        {"eros", "preparebudget", &preparebudget, true },
        {"eros", "submitbudget", &submitbudget, true },
        {"eros", "mnbudgetvote", &mnbudgetvote, true },
        {"eros", "getbudgetvotes", &getbudgetvotes, true },
        {"eros", "getnextsuperblock", &getnextsuperblock, true },
        {"eros", "getbudgetprojection", &getbudgetprojection, true },
        {"eros", "getbudgetinfo", &getbudgetinfo, true },
        {"eros", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"eros", "mnfinalbudget", &mnfinalbudget, true },
        {"eros", "checkbudgets", &checkbudgets, true },
        {"eros", "mnsync", &mnsync, true },
        {"eros", "spork", &spork, true },
