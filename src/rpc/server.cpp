...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* EROS features */
        {"eros", "listmasternodes", &listmasternodes, true, true, false},
        {"eros", "getmasternodecount", &getmasternodecount, true, true, false},
        {"eros", "masternodeconnect", &masternodeconnect, true, true, false},
        {"eros", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"eros", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"eros", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"eros", "masternodecurrent", &masternodecurrent, true, true, false},
        {"eros", "masternodedebug", &masternodedebug, true, true, false},
        {"eros", "startmasternode", &startmasternode, true, true, false},
        {"eros", "createmasternodekey", &createmasternodekey, true, true, false},
        {"eros", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"eros", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"eros", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"eros", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"eros", "getmasternodescores", &getmasternodescores, true, true, false},
        {"eros", "preparebudget", &preparebudget, true, true, false},
        {"eros", "submitbudget", &submitbudget, true, true, false},
        {"eros", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"eros", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"eros", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"eros", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"eros", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"eros", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"eros", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"eros", "checkbudgets", &checkbudgets, true, true, false},
        {"eros", "mnsync", &mnsync, true, true, false},
        {"eros", "spork", &spork, true, true, false},
        {"eros", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> eros-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18324/\n";
}
