...
extern UniValue setzersseed(const UniValue& params, bool fHelp);
extern UniValue getzersseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzers(const UniValue& params, bool fHelp);
extern UniValue dzersstate(const UniValue& params, bool fHelp);
