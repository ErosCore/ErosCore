...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4,           // ONLY_NONDENOMINATED and not 10000 ERS at the same time
...
public:
    ...
    // zERS wallet
    CzERSWallet* zwalletMain;
    std::unique_ptr<CzERSTracker> zersTracker;
