...
/** Utility functions used by the EROS Qt UI.
 */
namespace GUIUtil
{
...
// Render EROS addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZers = false);
...
// Parse "eros:" URI into recipient object, return true on successful parsing
