...
#include "qt/eros/coincontrolerswidget.h"
#include "qt/eros/forms/ui_coincontrolerswidget.h"

CoinControlErsWidget::CoinControlErsWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlErsWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select ERS Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("ERS");
    ...
    ui->labelValueAfter->setText("0.00 ERS");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 ERS");
    ui->labelValueFee->setText("0.00 ERS");
...
CoinControlErsWidget::~CoinControlErsWidget()
{
    delete ui;
}
