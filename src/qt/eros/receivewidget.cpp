...
#include "qt/eros/forms/ui_receivewidget.h"
...
#include "qt/eros/addressholder.h"
...
ReceiveWidget::ReceiveWidget(EROSGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive ERS."));
