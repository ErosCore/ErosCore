...
#include "config/eros-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalErs = 0;
    qint64 totalZers = 0;
    QList<qreal> valuesErs;
    QList<qreal> valueszErs;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(EROSGUI* _window);
    ~DashboardWidget();
