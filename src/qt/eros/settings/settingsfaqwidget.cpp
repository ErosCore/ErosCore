...
#include "qt/eros/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/eros/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(EROSGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableERS,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableERS,
    ...
    connect(ui->pushButton_UnspendableERS, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableERS);});
    ...
    if (parent)
        connect(parent, &EROSGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
