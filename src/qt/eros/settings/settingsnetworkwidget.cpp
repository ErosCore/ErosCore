...
#include "qt/eros/settings/settingsnetworkwidget.h"
#include "qt/eros/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/eros/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(EROSGUI* _window, QWidget *parent) :
