...
#include "qt/eros/settings/forms/ui_settingswidget.h"
...
#include "qt/eros/settings/settingswalletoptionswidget.h"
#include "qt/eros/settings/settingsmainoptionswidget.h"
#include "qt/eros/settings/settingsdisplayoptionswidget.h"
#include "qt/eros/settings/settingsmultisendwidget.h"
#include "qt/eros/settings/settingsinformationwidget.h"
#include "qt/eros/settings/settingsconsolewidget.h"
...
SettingsWidget::SettingsWidget(EROSGUI* parent) :
    PWidget(parent),
