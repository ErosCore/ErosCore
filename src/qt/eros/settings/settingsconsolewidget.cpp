...
#include "qt/eros/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/eros/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(EROSGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the EROS RPC console.") + "<br>" +
