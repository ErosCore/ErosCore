...
#include "qt/eros/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/eros/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(EROSGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to EROSGUI::handleRestart()
