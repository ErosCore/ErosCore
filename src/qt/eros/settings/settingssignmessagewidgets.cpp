...
#include "qt/eros/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(EROSGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsSignMessageWidgets)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText(tr("EROS address or contact label"));
