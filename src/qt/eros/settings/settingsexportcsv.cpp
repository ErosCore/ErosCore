...
#include "qt/eros/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(EROSGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("EROS_tx_csv_export(*.csv)") : tr("EROS_addresses_csv_export(*.csv)"),
                                        nullptr);
