...
#include "qt/eros/forms/ui_masternodeswidget.h"

#include "qt/eros/qtutils.h"
#include "qt/eros/mnrow.h"
#include "qt/eros/mninfodialog.h"
...
MasterNodesWidget::MasterNodesWidget(EROSGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:18325 6WjigbE95eMCebYHrbnoppZ6qnJJJvgET4ffmvFYmYbrPhTzA1t 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
