...
#include "qt/eros/forms/ui_coldstakingwidget.h"
#include "qt/eros/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/eros/requestdialog.h"
#include "qt/eros/tooltipmenu.h"
#include "qt/eros/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(EROSGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your ERSs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept ERS delegation / Delegate ERS"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select ERS outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 ERS" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
