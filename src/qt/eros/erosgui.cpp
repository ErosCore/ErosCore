...
const QString EROSGUI::DEFAULT_WALLET = "~Default";

EROSGUI::EROSGUI(const NetworkStyle* networkStyle, QWidget* parent) :
        QMainWindow(parent),
        clientModel(0){
...
void EROSGUI::connectActions()
{
    ...
    connect(topBar, &TopBar::showHide, this, &EROSGUI::showHide);
    connect(topBar, &TopBar::themeChanged, this, &EROSGUI::changeTheme);
    connect(topBar, &TopBar::onShowHideColdStakingChanged, navMenu, &NavMenuWidget::onShowHideColdStakingChanged);
    connect(settingsWidget, &SettingsWidget::showHide, this, &EROSGUI::showHide);
    connect(sendWidget, &SendWidget::showHide, this, &EROSGUI::showHide);
    connect(receiveWidget, &ReceiveWidget::showHide, this, &EROSGUI::showHide);
    connect(addressesWidget, &AddressesWidget::showHide, this, &EROSGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::showHide, this, &EROSGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::execDialog, this, &EROSGUI::execDialog);
    connect(coldStakingWidget, &ColdStakingWidget::showHide, this, &EROSGUI::showHide);
    connect(coldStakingWidget, &ColdStakingWidget::execDialog, this, &EROSGUI::execDialog);
    connect(settingsWidget, &SettingsWidget::execDialog, this, &EROSGUI::execDialog);
}
...
#ifndef Q_OS_MAC
void EROSGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void EROSGUI::closeEvent(QCloseEvent* event)
{
#ifndef Q_OS_MAC // Ignored on Mac
...
bool EROSGUI::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn)
{
    ...
    if (isVisible()) {
        ...
        dialog->setWindowTitle(tr("EROS Core"));
        dialog->adjustSize();
        dialog->raise();
        dialog->exec();
    }
...
bool EROSGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    connect(addressesWidget, &AddressesWidget::message,this, &EROSGUI::message);
...
static bool ThreadSafeMessageBox(EROSGUI* gui, const std::string& message, const std::string& caption, unsigned int style)
{
...
void EROSGUI::subscribeToCoreSignals()
{
    // Connect signals to client
    uiInterface.ThreadSafeMessageBox.connect(boost::bind(ThreadSafeMessageBox, this, _1, _2, _3));
}

void EROSGUI::unsubscribeFromCoreSignals()
{
