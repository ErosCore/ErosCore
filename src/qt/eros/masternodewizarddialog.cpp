...
#include "qt/eros/masternodewizarddialog.h"
#include "qt/eros/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 18325");
    ...
    if(walletModel->isTestNetwork()){
        ...
        ui->lineEditPort->setText("18326");
    } else {
        ui->lineEditPort->setText("18325");
    }
            ...
            if (boost::filesystem::exists(pathBootstrap)) {
                ...
                if (lineCopy.size() == 0) {
                    lineCopy = "# Masternode config file\n"
                               ...
                               "# Example: mn1 127.0.0.2:18325 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0"
                               "#";
                }
                lineCopy += "\n";
