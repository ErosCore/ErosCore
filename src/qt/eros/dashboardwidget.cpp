...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &EROSGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
...
void DashboardWidget::loadWalletModel()
{
    if (walletModel && walletModel->getOptionsModel()) {
        ...
        connect(ui->pushImgEmpty, &QPushButton::clicked, window, &EROSGUI::openFAQ);
        connect(ui->btnHowTo, &QPushButton::clicked, window, &EROSGUI::openFAQ);
