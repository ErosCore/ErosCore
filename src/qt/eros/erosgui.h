...
#ifndef EROS_CORE_NEW_GUI_EROSGUI_H
#define EROS_CORE_NEW_GUI_EROSGUI_H
...
#include "qt/eros/navmenuwidget.h"
...
#include "qt/eros/settings/settingswidget.h"
...
/**
  EROS GUI main class. This class represents the main window of the EROS UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class EROSGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit EROSGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~EROSGUI();
...
#endif //EROS_CORE_NEW_GUI_EROSGUI_H
