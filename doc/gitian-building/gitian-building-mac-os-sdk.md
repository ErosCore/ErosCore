...
The script [extract-osx-sdk.sh](https://github.com/ErosCore/eroscore/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
eros/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ErosCore/eroscore/blob/master/doc/README_osx.md) for troubleshooting tips.