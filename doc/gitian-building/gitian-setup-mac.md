...
The build script we'll be using is contained in the EROS github repository ([contrib/gitian-build.py](https://github.com/ErosCore/eroscore/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the EROS repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Eros/EROS/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, eros-detached-sigs, and eros GitHub repos.
