...
eros.conf           | contains configuration settings for erosd or eros-qt
erosd.pid           | stores the process id of erosd while running
...
debug.log           | contains debug information and general logging generated by erosd or eros-qt
