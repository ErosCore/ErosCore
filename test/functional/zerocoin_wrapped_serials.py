...
from fake_stake.base_test import EROS_FakeStakeTest

class zERSwrappedSerialsTest(EROS_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zERSs..." % DENOM_TO_USE)
