...
class RawTransactionsTest(ErosTestFramwork):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid eros address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid eros address" in e.error['message'])
