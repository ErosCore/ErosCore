...
"""Verify that starting eros with -h works as expected."""
import subprocess

from test_framework.test_framework import ErosTestFramwork
from test_framework.util import assert_equal

class HelpTest(ErosTestFramwork):
    ...
    def run_test(self):
        self.log.info("Start eros with -h for help text")
        ...
        self.log.info("Start eros with -version for version information")
