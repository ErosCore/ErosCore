...
from test_framework.eros_node import ErosTestNode
...
class EROS_ColdStakingTest(ErosTestFramwork):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(ErosTestNode())
