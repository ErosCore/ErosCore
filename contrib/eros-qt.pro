...
RESOURCES += src/qt/eros.qrc src/qt/eros_locale.qrc

TRANSLATIONS += src/qt/locale/eros_bg.ts \
                src/qt/locale/eros_de.ts \
                src/qt/locale/eros_en.ts \
                src/qt/locale/eros_es.ts \
                src/qt/locale/eros_fi.ts \
                src/qt/locale/eros_fr.ts \
                src/qt/locale/eros_it.ts \
                src/qt/locale/eros_ja.ts \
                src/qt/locale/eros_pl.ts \
                src/qt/locale/eros_pt.ts \
                src/qt/locale/eros_ru.ts \
                src/qt/locale/eros_sk.ts \
                src/qt/locale/eros_sv.ts \
                src/qt/locale/eros_vi.ts \
                src/qt/locale/eros_zh_CN.ts \
                src/qt/locale/eros_zh_TW.ts
