Contributing to EROS Core
============================

The EROS Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ErosCore/eroscore/blob/master/doc/translation_process.md)
...
The following applies to code changes to the EROS Core project, and is not to be
confused with overall EROS Network Protocol consensus changes.

Whether a pull request is merged into EROS Core rests with the project merge
...
Patches that change EROS consensus rules are considerably more involved than
...
Where a patchset proposes to change the EROS consensus, it must have been
...
The project leader is the release manager for each EROS Core release.
